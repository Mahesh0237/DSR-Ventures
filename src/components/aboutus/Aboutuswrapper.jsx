        ...
        <main className="about-page margin-top-page">
            ...
            <section className="space-section-main">
                <div className="section-wrapper">
                    <h3>Our Company.</h3>
                    <p>
                        <span>DSR VENTURES was established in 2011, with apartment
                            ...
                            with our clients. We take great pride in our accomplishments and build on them every day.</span>
                    </p>
                </div>
            </section>
                ...
                <div className="heading-wrapper">
                    <div className="space-wrapper bgs">
                        <div className="space-content">
                            <div className="content-block"><h3>Our Mission</h3><p><span>We also take great pride in being a customer-focused organization. This “customer-first” philosophy is constantly translated into trailblazing services and innovative activities. There are many dreams that inspire DSR VENTURES. Many avenues that await exploration. Many worlds that beckon us. It promises to be a glorious journey for DSR VENTURES. Check out for various options for plots in Bangalore. Travel with us -- and together, let’s celebrate our milestones and our achievements .</span> </p></div>
                            <div className="content-block"><h3>GROUP LINEAGE</h3><p><span>At DSR VENTURES, we value your time and your money. We understand that not only should your index be a refuge from the storms of life but also should give you excellent return on investment (ROI). Delivery schedules are strictly adhered to, and “value-for-money” is not just another buzz term with us: it’s a business philosophy.
                                We also take great pride in being a customer-focused organization. This “customer-first” philosophy is constantly translated into trailblazing services and innovative activities..</span></p></div>
